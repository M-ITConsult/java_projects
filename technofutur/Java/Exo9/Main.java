...
//        compte1.setSolde(500);
        ...
        // On get le solde
        System.out.printf("Solde en euro: %s€%n", compte3.getSolde());

        // Puis on le change en Dollar
        compte3.changerDevise(Devise.DOLLAR);
        System.out.printf("Solde en dollar: %s$%n", compte3.getSolde());
...
//        compte1.setSolde(500);
        ...
        // On get le solde
        System.out.printf("Solde en dollar: %s$%n", compte2.getSolde());

        // Puis on le change en Dollar
        compte2.changerDevise(Devise.EURO);
        System.out.printf("Solde en euro: %s€", compte2.getSolde());
